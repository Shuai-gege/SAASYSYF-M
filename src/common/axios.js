...
// axios.defaults.baseURL = 'http://bsbx.mallmis.com:8181'; //接口头正式环境
// axios.defaults.baseURL = 'https://test.mallmis.com/v1'; //弘扬小程序接口头测试环境
axios.defaults.baseURL = 'https://test.mallmis.com/v3'; //盈商云服小程序接口头测试环境
// axios.defaults.baseURL = 'http://47.100.240.228:8281'; //弘扬 接口头测试环境
axios.defaults.timeout = 60000; //超时毫秒 60s
axios.defaults.headers.post["Content-Type"] = "application/json;charset=UTF-8"; //请求头
axios.defaults.headers.common['LinkAdmin-Token'] = '4mx4SbYEMH+OGJbC91Rt2g==';
